...
### [Repository](https://github.com/calebpool96/Laptop-Dataset-Portfolio-)
...
I found that the "Core i9-13900KS" was the best in the CPU table; so my next step was writing a query to search for any laptops with the top CPU but it didn't return anything so I decided not to include it. 
...
I Compared both chips Specs on [Intel's Website](https://www.intel.com/content/www/us/en/products/compare.html?productIds=97464,88969) and downloaded the table from the page then cleaned it in sheets, added it to the MySql database, and inserted the data into the cpu specs table.
...
The TDP in this cpu is too low for 99.1% of games according to the video game requirements table.
According to [Ace Cloud Hosting](https://www.acecloudhosting.com/blog/what-is-tdp-for-cpus-and-gpus/) "For a CPU, TDP is a measure of the maximum amount of heat that a CPU can generate and still perform within its specified temperature range." so it is important to the laptop.
I want to find a CPU that can run at-least 50% of the games in the video game requirements table.
...
What "LaptopIDs" are "Gaming" type laptops and have an "Ryzen 1700" CPU and what is their GPU(s)/RAM(GB)?
```
SELECT
    LaptopID,
    GPU,
